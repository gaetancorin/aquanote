...
class app_tests extends \PHPUnit\Framework\TestCase{
    ...
    protected function setUp(): void {
        ...
        $this->dateValuesSelectorRepository->connection = $this->DatabaseConnection;
        $this->commentAnalysisRepository = new CommentAnalysisRepository();
        $this->commentAnalysisRepository->connection = $this->DatabaseConnection;
    }
    ...
    public function get_user_by_email_or_by_id(){
        ...
        $User = $this->userRepository->getUserById($user->id_user);
        $this->assertNotNull($User);
    }
    ...
    public function test_create_aquarium_by_id_user(){
        ...
        $this->aquariumRepository->createAquarium('aquariumName2', $user->id_user);
    ...
    public function test_create_value_types_analysis_by_id_type_analysis(){
        ...
        $this->valueTypeAnalysisRepository->createValueTypeAnalysis('11.1', '2022-08-01', $typesAnalysis[0]->id_type_analysis);
        $this->valueTypeAnalysisRepository->createValueTypeAnalysis('22.2', '2022-08-02', $typesAnalysis[0]->id_type_analysis);
        $this->valueTypeAnalysisRepository->createValueTypeAnalysis('33.3', '2022-08-03', $typesAnalysis[0]->id_type_analysis);
        // récupération d'un type_analysis et test de classe d'instance
        $valueTypeAnalysis = $this->valueTypeAnalysisRepository->getValueTypeAnalysisByDateAnalysisAndIdTypeAnalysis('2022-08-01', $typesAnalysis[0]->id_type_analysis);
    ...
    public function test_update_value_types_analysis_by_date_and_id_type_analysis(){
        ...
        $this->valueTypeAnalysisRepository->updateValueTypeAnalysisByDateAnalysisAndIdTypeAnalysis( '33.4', '2022-08-03', $typesAnalysis[0]->id_type_analysis);
        // récupération du value_type_analysis
        $valueTypeAnalysis = $this->valueTypeAnalysisRepository->getValueTypeAnalysisByDateAnalysisAndIdTypeAnalysis('2022-08-03', $typesAnalysis[0]->id_type_analysis);
        // test d'existance d'instance et de valeur d'attribut
        $this->assertContainsOnlyInstancesOf( ValueTypeAnalysis::class, [$valueTypeAnalysis]);
        $this->assertSame('33.4', $valueTypeAnalysis->value_type_analysis);
    }
    ...
    public function test_delete_value_types_analysis_by_date_and_id_type_analysis(){
        ...
        $this->valueTypeAnalysisRepository->deleteValueTypeAnalysisByDateAnalysisAndIdTypeAnalysis('2022-08-03', $typesAnalysis[0]->id_type_analysis);
        // récupération du value_type_analysis et test de non existance
        $notValueTypeAnalysis = $this->valueTypeAnalysisRepository->getValueTypeAnalysisByDateAnalysisAndIdTypeAnalysis('2022-08-03', $typesAnalysis[0]->id_type_analysis);
    ...
    public function test_list_of_date_values_selector(){
        ...
        $this->dateValuesSelectorRepository->getAllDatesWhereAreValuesTypesAnalysisByIdAquarium($aquarium->id_aquarium);
        // transforme cette liste en liste d'instances de DateValuesSelector ayant comme attribut une date, ainsi qu'une liste d'instances de tous les type_analysis de cette aquarium contenant une instance de value_analysis si la valeur existe pour ce type_analysis
        $list_of_date_values_selector = $this->dateValuesSelectorRepository->DoListOfDatesContainsArrayTypesAnalysisObjectsWithValue($aquarium->id_aquarium);
    ...
    public function test_create_comment_analysis_by_id_aquarium(){
        ...
        $this->commentAnalysisRepository->createCommentAnalysis('un commentaire d\'analyse', '2022-08-01', $aquarium->id_aquarium);
        $comment_analysis = $this->commentAnalysisRepository->getCommentAnalysisByDateAnalysisAndIdAquarium('2022-08-01', $aquarium->id_aquarium);
    ...
    public function test_update_comment_analysis_by_id_aquarium(){
        ...
        $this->commentAnalysisRepository->updateCommentAnalysisByDateAnalysisAndIdAquarium('un commentaire d\'analyse modifié', '2022-08-01', $aquarium->id_aquarium);
        $update_comment_analysis = $this->commentAnalysisRepository->getCommentAnalysisByDateAnalysisAndIdAquarium('2022-08-01', $aquarium->id_aquarium);
        $this->assertSame('un commentaire d\'analyse modifié', $update_comment_analysis->comment_analysis);
    }
    ...
    public function test_delete_comment_analysis_by_id_aquarium(){
        ...
        $this->commentAnalysisRepository->deleteCommentAnalysisByDateAnalysisAndIdAquarium('2022-08-01', $aquarium->id_aquarium);
        $notCommentAnalysis = $this->commentAnalysisRepository->getCommentAnalysisByDateAnalysisAndIdAquarium('2022-08-01', $aquarium->id_aquarium);
    ...
    public function test_update_aquarium_name_by_id(){
        $user = $this->userRepository->getUserByEmail('mrTest@mrTest.fr');
        $aquarium = $this->aquariumRepository->getAquariumByNameAndIdUser('aquariumName2', $user->id_user); 
        // modification de l'aquarium, récupération et et test dee l'attribut modifié
        $this->aquariumRepository->updateNameAquariumById('aquariumName2Modifie', $aquarium->id_aquarium);
        $aquariumModifie = $this->aquariumRepository->getAquariumById($aquarium->id_aquarium);
        $this->assertSame('aquariumName2Modifie', $aquariumModifie->name_aquarium);
    }
    /** delete du second aquarium du user **/
    public function test_delete_aquarium_by_id(){
        $user = $this->userRepository->getUserByEmail('mrTest@mrTest.fr');
        $aquarium = $this->aquariumRepository->getAquariumByNameAndIdUser('aquariumName2Modifie', $user->id_user); 
        // suppression de l'aquarium, tentative de récupération et test d'existance
        $this->aquariumRepository->deleteAquariumsById($aquarium->id_aquarium);
        $Notaquarium = $this->aquariumRepository->getAquariumById($aquarium->id_aquarium);
